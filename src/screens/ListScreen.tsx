    ...
    return (
        <View style={styleList.container}>
            ...
            <View style={{ paddingTop: 5 }}>
                <ShortCard name='Nisarg' amount={48} currency='$' date='2021-04-22' time='02:15' status='completed' logo="https://raw.githubusercontent.com/nisargdongare/ListDesign/main/src/logo/logo51.svg" />
